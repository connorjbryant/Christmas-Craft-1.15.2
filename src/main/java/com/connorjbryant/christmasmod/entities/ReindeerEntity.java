package com.connorjbryant.christmasmod.entities;
...
public class ReindeerEntity extends AnimalEntity {
	...
	public AgeableEntity createChild(AgeableEntity ageable) {
		ReindeerEntity entity = new ReindeerEntity(ModEntityTypes.REINDEER_ENTITY.get(), this.world);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new TemptGoal(this, 1.1D, Ingredient.fromItems(ItemInit.candy.get()), false));
