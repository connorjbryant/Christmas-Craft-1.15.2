...
public class ChristmasChunkGenerator extends NoiseChunkGenerator<ChristmasGenSettings> {
	...
	public ChristmasChunkGenerator(IWorld worldIn, BiomeProvider provider, ChristmasGenSettings settingsIn) {
