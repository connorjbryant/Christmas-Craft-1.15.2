...
public class ChristmasBiome extends Biome {
	
	public ChristmasBiome(Builder biomeBuilder) {
		super(biomeBuilder);
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
		 ...
		 this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
		 Feature.NORMAL_TREE.withConfiguration(CandyTree.CANDY_TREE_CONFIG).withPlacement(
