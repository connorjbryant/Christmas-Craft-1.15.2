...
public class LicoriceChestBlock extends Block {
	...
	public LicoriceChestBlock(Properties properties) {
		super(properties);
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return ModTileEntityTypes.LICORICE_CHEST.get().create();
	}
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player,
		...
		if (!worldIn.isRemote) {
			...
			if (tile instanceof LicoriceChestTileEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) player, (LicoriceChestTileEntity) tile, pos);
	...
	public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
		if (state.getBlock() != newState.getBlock()) {
			...
			if (te instanceof LicoriceChestTileEntity) {
				InventoryHelper.dropItems(worldIn, pos, ((LicoriceChestTileEntity) te).getItems());
			}
		}
	}
}
