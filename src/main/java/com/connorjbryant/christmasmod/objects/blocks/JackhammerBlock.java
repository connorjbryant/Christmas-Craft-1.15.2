...
public class JackhammerBlock extends Block {
	...
	public JackhammerBlock(Properties properties) {
		super(properties);
	...
	public void addInformation(ItemStack stack, IBlockReader worldIn, List<ITextComponent> tooltip,
			ITooltipFlag flagIn) {
		tooltip.add(new StringTextComponent("\u00A7e" + "Place this jackhammer down for it to automatically dig a hole down to bedrock. Then collect the coal it mined for the naughty childern, or collect whatever resources you desire."));
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return ModTileEntityTypes.jackhammer.get().create();
	}
