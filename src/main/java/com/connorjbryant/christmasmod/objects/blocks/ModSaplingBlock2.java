...
public class ModSaplingBlock2 extends BushBlock implements IGrowable {

	public static final IntegerProperty STAGE = BlockStateProperties.STAGE_0_1;
	protected static final VoxelShape SHAPE = Block.makeCuboidShape(8.0D, 9.0D, 8.0D, 7.0D, 4.0D, 1.0D);
	private final Supplier<Tree> tree;

	public ModSaplingBlock2(Supplier<Tree> treeIn, Properties properties) {
		super(properties);
		this.tree = treeIn;
	}
	...
	public void tick(BlockState state, ServerWorld worldIn, BlockPos pos, Random rand) {
		...
		if (worldIn.getLight(pos.up()) >= 1 && rand.nextInt(1) == 0) {
