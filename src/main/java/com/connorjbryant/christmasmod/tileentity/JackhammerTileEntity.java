...
import com.connorjbryant.christmasmod.util.helpers.NBTHelper;
...
public class JackhammerTileEntity extends TileEntity implements ITickableTileEntity {
	
	public int x, y, z, tick;
	boolean initialized  = false;

	public JackhammerTileEntity(final TileEntityType<?> tileEntityTypeIn) {
		super(tileEntityTypeIn);
	}
	
	public JackhammerTileEntity() {
		this(ModTileEntityTypes.jackhammer.get());
	}
